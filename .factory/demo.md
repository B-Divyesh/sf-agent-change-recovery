...
- Desktop sample: enter a 12-character-or-longer ledger passphrase, then choose **Load sample project** on the desktop first-run screen. It creates an isolated `sample-project` inside app data, encrypts its checkpoints, never reads a chosen project, and **Reset sample project** recreates it.
